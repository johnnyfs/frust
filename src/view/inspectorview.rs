...
mod tests {
    use crate::{
        ...
        data::world::TerrainType,
        ecs::{SIGN_POSITION, SQUIRREL_POSITIONS, spawn_initial_entities},
        view::worldview::terrain_marker,
    };
    use ratatui::style::Color;
    ...
    fn terrain_marker_matches_worldview() {
        ...
        assert_eq!(terrain_marker(TerrainType::Grass), ('.', Color::LightGreen));
    }
}
